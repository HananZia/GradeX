...
from gradex_app import views, HodViews, StaffViews, StudentViews
from gradex_app.EditResultVIewClass import EditResultViewClass
...
urlpatterns = [
    ...
    # path('check-email/', views.check_email_exist, name='check_email_exist'),
 ...
 #     Staff URL Path
    ...
    path("student_view_subjects", views.student_view_subjects, name="student_view_subjects"),
